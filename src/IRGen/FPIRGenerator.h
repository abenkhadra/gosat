...
public:
    ...
    explicit IRSymbol(SymbolKind kind, const z3::expr &expr, llvm::Value *value) :
            Symbol(kind, expr), m_value(value) {}
...
private:
    ...
    const IRSymbol *genNumeralIR(llvm::IRBuilder<> &builder, const z3::expr &expr) noexcept;
    ...
    SymMapType::const_iterator findSymbol(const SymbolKind kind, const z3::expr &expr) const noexcept;
...
private:
    ...
    std::vector<const IRSymbol *> m_var_sym_vec;
